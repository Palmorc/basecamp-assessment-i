...
var notHakeem;
  if (myName != 'Hakeem Olajuwon'){return 'Your name is not Hakeem!,'};
...
var responseCreator = function(param){
  ...
  else if (param){colorResponse = "What is your favorite color?"}
}
...
function greeter(name,number){
  'Hi my name is'+name+'and I am'+number+'years old.'
}
